...
<div class="card">
 ...
 <a href="../informacion y creacion/detalles grupo administracion alpha.php" class="btn btn-warning"> Volver Atras</a> Miembro
  </div> 


  <div class="card-body">
  <form method="POST" action=" alpha insertar.php">
