...
<div class="card">
 ...
 <a href="../informacion y creacion/detalles grupo administracion delta.php" class="btn btn-warning"> Volver Atras</a> Miembro
  </div> 


  <div class="card-body">
  <form method="POST" action="delta insertar.php">


  <div class="grupo delta">
                            <label for="grupo delta" class="form-label">Nombre:</label>
