                ...
                <div class="table-responsive">
                    <table class="table table-striped table-sm" id="tablax">
                        ...
                        <tbody>
                                ...
                                $sql = "SELECT Id,f.Nombre,f.Apellido,repositorio,linkedIn,portafolio,curriculum FROM evaluaciones e INNER JOIN formulario f ON f.Id_formulario = e.Id_formulario";
